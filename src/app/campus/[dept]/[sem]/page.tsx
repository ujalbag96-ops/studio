...
import { FileText, Download, Loader2, ArrowLeft, Zap, Lock, ShieldCheck, X, Sparkles, PlayCircle, Clock, ChevronRight } from 'lucide-react';
...
export default function ChapterListScreen() {
  ...
  const proceedToViewer = async () => {
    ...
    try {
      // Activity-Linked Scholar Dividend Trigger
