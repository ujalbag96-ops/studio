    ...
    <div className="max-w-6xl mx-auto p-6 md:p-12 space-y-12 pb-32">
      <div className="flex items-center justify-between">
         ...
         <div className="flex gap-3">
            ...
            <Badge className="bg-primary/20 text-primary border-none uppercase font-black px-4 py-1.5 shadow-xl text-[9px]">{className}</Badge>
         </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8">
           <div className="space-y-2">
              ...
              <p className="text-muted-foreground font-medium text-lg uppercase tracking-tight">
                Accessing official {source} Subject streams for {className}.
              </p>
           </div>
