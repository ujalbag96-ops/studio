    ...
    <div className="max-w-7xl mx-auto px-8 py-16 space-y-24 pb-40">
      ...
      <section className="relative glass-panel rounded-[4rem] p-12 md:p-24 overflow-hidden flex flex-col items-center text-center space-y-12">
        ...
        <div className="space-y-8 relative z-10 max-w-4xl">
          <div className="flex flex-wrap items-center justify-center gap-4">
             <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-green-500/10 border border-green-500/20 backdrop-blur-md">
          ...
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter leading-[0.8] text-white uppercase italic">
            Student <br />
            <span className="text-primary">Earning Hub</span>
          </h1>
          ...
          <p className="text-xl text-muted-foreground font-medium max-w-2xl mx-auto leading-relaxed uppercase tracking-tight opacity-70">
            Professional student resources and strategic free earning missions. Build your scholarship fund without any investment.
          </p>
      ...
      <div className="space-y-4">
         <div className="flex items-center justify-between px-4">
            <h3 className="text-sm font-black uppercase tracking-[0.4em] text-muted-foreground italic">Student Sectors</h3>
         </div>
      ...
      <section className="grid md:grid-cols-3 gap-12 pt-12 border-t border-white/10">
         <TrustBlock icon={<Coins />} title="Zero Investment" desc="No deposit needed. Earn coins via free academic tasks." />
         <TrustBlock icon={<ShieldCheck />} title="Student Secure" desc="Industrial AES encryption protecting student data." />
         <TrustBlock icon={<Zap />} title="Direct Payout" desc="Instant withdrawal terminal for verified earnings." />
      </section>
    </div>
  );
}
