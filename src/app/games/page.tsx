  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-10 space-y-12 pb-32">
      <header className="space-y-6 pt-12 text-center md:text-left">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
           <div className="space-y-4">
              <Badge className="bg-primary/20 text-primary border-none uppercase font-black tracking-widest px-4 py-1 text-[9px]">50-Level Arcade Engine</Badge>
              ...
              <p className="text-muted-foreground font-medium text-lg max-w-xl">Skill-based progression. No betting, zero gambling. Earn coins by mastering levels.</p>
           </div>
           ...
           <Card className="w-full md:w-80 bg-gradient-to-br from-[#1a1a24] to-black border-primary/20 border-2 rounded-[2.5rem] p-6 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                 ...
                 <h4 className="text-xl font-black text-white uppercase italic">Level {( (profile?.puzzleLevel || 1) + (profile?.physicsLevel || 1) + (profile?.runnerLevel || 1) )} Combined</h4>
      ...
      <section className="pt-10">
         <Card className="bg-[#0a0a0f] border-dashed border-2 border-white/5 p-12 rounded-[3rem] flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="space-y-4 text-center md:text-left">
               <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-amber-500/10 border border-amber-500/20">
                  ...
                  <span className="text-[9px] font-black text-amber-500 uppercase tracking-widest">Fair Play Verified</span>
               </div>
               <h3 className="text-3xl font-black uppercase italic text-white leading-none">Automatic Reward <span className="text-primary">Scaling</span></h3>
               <p className="text-muted-foreground text-sm font-medium max-w-xl">
                  Difficulty increases every 5 levels. Winnings scale from 2 coins (Level 1) to 50 coins (Level 50).
               </p>
            </div>
