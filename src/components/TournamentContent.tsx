...
import { Trophy, Calendar, Users, Key, Gamepad2, Coins, Loader2, ArrowLeft, ShieldCheck, Zap, Radio } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-500 pb-32">
      ...
      {activeTab === 'info' ? (
          ...
          <div className="md:col-span-2 space-y-8">
            <Card className="bg-white/5 border-white/5 rounded-[2rem] p-8">
               <div className="grid grid-cols-2 gap-6">
                  <div className="flex items-center gap-4">
                     <div className="h-12 w-12 bg-black/60 rounded-2xl flex items-center justify-center border border-white/5"><Trophy className="text-amber-400" /></div>
                     <div><p className="text-[8px] font-black uppercase text-muted-foreground tracking-widest">Prize Pool</p><p className="text-sm font-black italic">{tournament.prizePool}</p></div>
                  </div>
                  <div className="flex items-center gap-4">
                     <div className="h-12 w-12 bg-black/60 rounded-2xl flex items-center justify-center border border-white/5"><Coins className="text-primary" /></div>
                     <div><p className="text-[8px] font-black uppercase text-muted-foreground tracking-widest">Entry Fee</p><p className="text-sm font-black italic">{finalFee} 🪙</p></div>
                  </div>
               </div>
            </Card>
              ...
              <Card className="bg-[#0a0a0f] border-primary/20 rounded-[2rem] p-8 shadow-2xl">
                 <div className="space-y-6">
                    <div className="space-y-2">
                       <Label className="text-[9px] font-black uppercase tracking-widest text-muted-foreground ml-1">Game User ID</Label>
        ...
        <div className="aspect-video bg-black rounded-[3rem] overflow-hidden border border-white/5 flex items-center justify-center">
           <p className="text-xs font-black uppercase text-white/20 tracking-widest">Stream Offline</p>
        </div>
      )}
    </div>
  );
