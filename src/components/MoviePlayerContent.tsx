...
export default function MoviePlayerContent() {
      ...
      <div className="grid lg:grid-cols-3 gap-10">
         <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed font-medium uppercase tracking-tight opacity-80 pt-4">
               Tactical content delivery network active. This stream is encrypted via industrial AES-256 protocols.
            </p>
         </div>
